...
if(!message.member.roles.cache.has(ayarlar.JailYetkilisi) && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.send('Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.')
  ...
  if(!kişi) return message.channel.send('Jaile Atacağın **Kullanıcıyı** Etiketle!')
  if(kişi.roles.highest.position >= message.member.roles.highest.position) return message.channel.send('Etiketlediğin **Kullanıcı** Seninle Aynı/Üst Yetkide Bulunuyor.')
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\  
  ...
  let zaman = args[1]
  if(!args[1]) return message.channel.send('Jailde Ne Kadar **Süre** Duracağını Yaz!')

let sebep = args.join(``).slice(args[1].length+args[0].length)
if(!sebep) return message.channel.send('Birini Jaile Atmak için **Sebep** Belirtmelisin.')
